...
function Update.updateProcedure()   --creting update procedure
   ...
   conn_dev:execute{sql=[[CREATE PROCEDURE Update_Procedure( 
    IN UNIQUE_TRANS_NUM varchar(45)
      ...
      BEGIN
       update 3pl_sps_ordering.csos_order_header set CSOS_ORDER_HDR_STAT ='2' where UNIQUE_TRANS_NUM=UNIQUE_TRANS_NUM;
     update  3pl_sps_ordering.order_header set  ORDER_HDR_STAT_DESC='2' where CSOS_ORDER_NUM=UNIQUE_TRANS_NUM;
